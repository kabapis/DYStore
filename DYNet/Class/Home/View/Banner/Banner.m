...
-(void)initSegmentWithImgCount:(CGFloat)count
{
...
-(void)createViewsWithImageArray:(NSMutableArray *)imgArray
{
    ...
    Banner_ScrollView = [[UIScrollView alloc] initWithFrame:CGRectMake(0, 0, Width_Banner, height_Banner-BannerSegmentHeight)];
